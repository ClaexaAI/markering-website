...
import {BookOpen, Sparkles, Users} from 'lucide-react'; // Example icons
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="md:pr-12">
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
                Claexa AI began as an ambitious college project by two students, <strong className="text-foreground">Soumajit
                Ghosh</strong> and <strong className="text-foreground">Saurodip Singha</strong>. What started as a
                passion for AI and education has blossomed into a platform that now proudly assists hundreds of teachers
                in their day-to-day tasks, streamlining workflows and enhancing the learning experience.
              </p>
            ...
            <div
              className="hidden md:flex items-center justify-center p-8 bg-primary/10 rounded-lg shadow-xl aspect-square">
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-12 leading-relaxed">
            To empower educators with intelligent, intuitive, and accessible AI tools that save time, enhance teaching
            quality, and foster a more engaging learning environment for students everywhere.
          </p>
